...
{
   public class IModifyUserInterface
    {
        public JObject ModifyUser(int id, string code, string name, int mobile,  string token)
        {
            ...
            string resultJson = HttpHelper.postJson(Urls.MODIFY_USER, map, token);
            Console.Write("修改用户返回结果：" + resultJson);
