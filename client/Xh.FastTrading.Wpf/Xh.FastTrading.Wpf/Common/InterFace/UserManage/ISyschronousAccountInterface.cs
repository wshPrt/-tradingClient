...
{
   public class ISyschronousAccountInterface
    {
        public JObject SyschronousAccount(string token)
        {
            JObject jobject = new JObject();
            string resultJson = HttpHelper.postJson(Urls.SYNCHRONOUS_TRANSACTION_SERVER_IP, null, token);
            Console.Write("同步返回结果：" + resultJson);
