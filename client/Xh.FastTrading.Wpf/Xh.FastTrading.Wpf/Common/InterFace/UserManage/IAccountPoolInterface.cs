...
{
  public  class IAccountPoolInterface
    {
        public JObject AccountPool(string token)
        {
            JObject jobject = new JObject();
            string resultJson = HttpHelper.postJson(Urls.ACCOUNT_POOL_LIST, null, token);
            Console.Write("主账户池列表返回结果：" + resultJson);
