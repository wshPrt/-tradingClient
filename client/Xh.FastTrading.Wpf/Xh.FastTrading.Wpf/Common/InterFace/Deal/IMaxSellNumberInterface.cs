...
{
  public  class IMaxSellNumberInterface
    {
        public JObject MaxSellNumber(int unit_id, string code, int type, int account_id, string token)
        {
            ...
            Console.Write("最大可卖数量 返回结果：" + resultJson);
