...
namespace MaterialDesignThemes.Wpf.Converters
{
    internal static class ShadowInfo
    {
        ...
        static ShadowInfo()
        {
            var resourceDictionary = new ResourceDictionary { Source = new Uri("pack://application:,,,/Sup-Trade;component/Themes/MaterialDesignTheme.Shadows.xaml", UriKind.Absolute) };
