...
namespace UpdateConsole
{
    ...
    public class HttpHelper
    {
        ...
        public static async Task<string> HttpRequest(string url, string body, string method = "POST", string contentType = "application/json")
        {
            HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(url);
        ...
        /// <returns></returns>
        public static string HttpPostData(string url, int timeOut, string fileKeyName, string filePath, string stringDict)//NameValueCollection stringDict)
        {
            ...
            byte[] formitembytes = Encoding.UTF8.GetBytes(string.Format(stringKeyHeader, "data", stringDict));
        ...
        public static void post1(string token)
        {
            string url = "http://192.168.1.7:8088/a/api/v1/printTemplates/picture?access_token=" + token; //@"http://192.168.1.7:8088/a/printTemplates/picture?" + token;//这里就不暴露我们的地址啦
